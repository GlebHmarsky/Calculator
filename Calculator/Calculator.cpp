...
BEGIN_MESSAGE_MAP(CCalculatorApp, CWinApp)
	...
	ON_COMMAND(ID_FILE_OPEN, &CCalculatorApp::ResetFile)
END_MESSAGE_MAP()


// CCalculatorApp construction

void CCalculatorApp::ResetFile()
{
	OnFileOpen();
}
...
CCalculatorApp::CCalculatorApp() noexcept
{
	...
	SetAppID(_T("Calculator.AppID.NoVersion"));
...
BOOL CCalculatorApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CCalculatorDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CCalculatorView));
	if (!pDocTemplate)
		return FALSE;
	...
	m_pMainWnd->SetWindowText(_T("Calculator"));
	return TRUE;
}

// CCalculatorApp message handlers
...
void CCalculatorApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
